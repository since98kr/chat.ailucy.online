...
export class FederationService {
  ...
  private migrate() {
    this.db.exec(`
      CREATE TABLE IF NOT EXISTS conversation_federation (
        ...
        allowed_system_ids_json TEXT NOT NULL DEFAULT '["openclaw","hermes","claude"]',
  ...
  enableConversation(conversationId: string, coordinatorAgentId = '[Hermes] Lucy') {
    ...
    `).run(conversationId, coordinatorAgentId, JSON.stringify(CANONICAL_SYSTEM_IDS), createdAt, createdAt);
