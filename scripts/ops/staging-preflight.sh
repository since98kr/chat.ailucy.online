...
bash "${SCRIPT_DIR}/staging-qa-gate.sh" || fail 'staging QA required flags are not deployable'
...
ENV_VARS=(
  ...
  CHAT_MULTIMODAL_QA_REQUIRED CHAT_GENERATED_ARTIFACT_QA_REQUIRED CHAT_EXTERNAL_QA_REQUIRED
  ...
  LETTA_NATIVE_BINARY_ARTIFACTS LETTA_ARTIFACT_TOOL_ENABLED
  CF_ACCESS_CLIENT_ID CF_ACCESS_CLIENT_SECRET
  LETTA_READINESS_PROBE_ENABLED LETTA_READINESS_PROBE_MODEL LETTA_READINESS_PROBE_PROMPT
